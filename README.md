...
driver boards and how to use them with the SKR PRO V1.2 (3D printer controller) board.  This manual also 
shows the user how to connect additional equipment to the SKR PRO V1.2 Board: Raspberry Pi, BLTouch, 
...
$ git clone https://github.com/GadgetAngel/SKR-PRO-V1.2-Stepper-Driver-Jumper-Configuration-Manual.git
...
```
Stepper Driver Jumper Configurations for SKR PRO V1.2 Board
By       @GadgetAngel
...
POLOLU A4988......................................................................................................6
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set...........7
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board8
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers
...
BIQU A4988.......................................................................................................17
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set..........18
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board.........................................19
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers
    Which Have RST&SLP Set.......................................................................................21
  The (latest release of) Marlin Setup for BIQU A4988 Drivers....................................................26
DRV8825..........................................................................................................28
  Driver Chip Chart for DRV8825..................................................................................28
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set..........29
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board.........................................30
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
    Which Have RST&SLP Set.......................................................................................32
  The (latest release of) Marlin Setup for DRV8825 Drivers.......................................................38
BIQU LV8729......................................................................................................41
  Driver Chip Chart for BIQU LV8729..............................................................................41
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set...42
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers
...
FYSETC LV8729....................................................................................................54
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set...55
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
LERDGE LV8729....................................................................................................67
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set...68
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
MKS LV8729.......................................................................................................80
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set...81
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
FYSETC S6128 V1.1................................................................................................93
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set..........94
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board.........................................95
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
FYSETC ST820....................................................................................................107
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set.........108
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board........................................109
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
BIQU ST820......................................................................................................122
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set.........123
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board........................................124
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
POLOLU ST820 (STSPIN820)........................................................................................137
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set.........138
    Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board........................................139
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
POLOLU MP6500...................................................................................................152
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers 
...
BIQU S109.......................................................................................................176
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set..177
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
FYSETC S109.....................................................................................................189
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Do Not Have RST&SLP PINS Set..190
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
...
BIQU TMC2100 Stand-alone Mode...................................................................................202
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 1...............................203
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 2...............................204
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Tri State Stepper Motor Drivers.......................206
...
MKS TMC2100 Stand-alone Mode....................................................................................215
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 1...............................216
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 2...............................217
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Tri State Stepper Motor Drivers.......................219
...
BIQU TMC2130 (SA) Stand-alone Mode..............................................................................228
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 1...............................229
  SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers - PART 2...............................230
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Tri State Stepper Motor Drivers.......................232
BIQU TMC2130 SPI Mode...........................................................................................241
  Driver Chip Chart for BIQU TMC2130 in SPI Mode................................................................241
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in SPI Mode.....................244
  Information on Sensor-less Homing for SKR PRO V1.2............................................................247
...
BIQU TMC2208 V3.0 (SA) Stand-alone Mode for StealthChop.........................................................266
  ...
  SKR PRO V1.2 LEGEND of Driver Chip Chart for TMC Binary State Stepper Drivers
    in Stand-alone Mode (StealthChop)...........................................................................267
  SKR PRO V1.2 LEGEND of Driver Socket Representation for TMC Binary State Stepper Motor 
...
BIQU TMC2208 V3.0 (OTP) Stand-alone Mode for SpreadCycle........................................................277
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for TMC Binary State Stepper Motor Drivers 
...
BIQU TMC2208 V3.0 UART Mode.....................................................................................288
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in UART Mode....................291
...
FYSETC TMC2208 V1.2 UART Mode...................................................................................328
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in UART Mode....................331
...
BIQU TMC2225 V1.0 UART Mode.....................................................................................368
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in UART Mode....................371
...
BIQU TMC2209 V1.2 UART Mode.....................................................................................408
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in UART Mode....................411
  Information on Sensor-less Homing for SKR PRO V1.2............................................................415
...
BIQU TMC2226 V1.0 UART Mode.....................................................................................456
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in UART Mode....................459
  Information on Sensor-less Homing for SKR PRO V1.2............................................................463
...
BIQU TMC5160 V1.2 SPI Mode......................................................................................482
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in SPI Mode.....................485
  Information on Sensor-less Homing for SKR PRO V1.2............................................................488
...
BIQU TMC5161 V1.0 SPI Mode......................................................................................507
  ...
  SKR PRO V1.2 LEGEND of Driver Socket Representation for Stepper Motor Drivers in SPI Mode.....................510
  Information on Sensor-less Homing for SKR PRO V1.2............................................................513
...
APPENDIX C......................................................................................................542
  The (Latest Release of) Marlin Setup That Is Common to ALL Stepper Motor Drivers..............................542
    ...
    SKR PRO V1.2 Color PIN Diagram..............................................................................560
    SKR PRO V1.2 Color Wiring Diagram...........................................................................561
    SKR PRO V1.2 Color PIN 1 Diagram............................................................................563
    SKR PRO V1.2 Color Schematic Diagram........................................................................564
    SKR PRO V1.2 Uncolored Schematic Diagram....................................................................565
APPENDIX D......................................................................................................566
  Legends for SKR PRO V1.2 Stepper Driver Jumper Configurations.................................................566
  SKR PRO V1.2 LEGEND COMMON to ALL Driver Socket Representation................................................567
  SKR PRO V1.2 LEGENDS for Driver Socket Representations and LEGENDS for Driver Chip Charts.....................571
    SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
      Which Have RST&SLP Set....................................................................................571
    SKR PRO V1.2 LEGEND of Driver Chip Chart for Binary State Stepper Drivers Which Have RST&SLP PINS Set.......574
      Special Consideration of “D” Jumper (RST&SLP) for SKR PRO V1.2 Board......................................575
    SKR PRO V1.2 LEGEND of Driver Socket Representation for Binary State Stepper Motor Drivers 
    ...
    SKR PRO V1.2 LEGEND of Driver Socket Representation for Tri State Stepper Motor Drivers.....................586
    SKR PRO V1.2 LEGEND of Driver Chip Chart for Tri State Stepper Drivers......................................588
    SKR PRO V1.2 LEGEND of Driver Socket Representation for SPI Capable Stepper Motor Drivers...................589
    SKR PRO V1.2 LEGEND of Driver Socket Representation for UART Capable Stepper Motor Drivers..................596
    SKR PRO V1.2 LEGEND of Driver Socket Representation for Sensor-less Homing Capable Stepper Motor Drivers....605
  SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations.................................................611
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for Binary State Drivers without RST&SLP Set..611
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for Binary State Drivers with RST&SLP Set.....615
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for Tri State Drivers.........................619
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for TMC2209 with Sensor-less Homing...........626
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for TMC2209 without Sensor-less Homing........627
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for TMC2130 with Sensor-less Homing...........628
    SKR PRO V1.2 Examples of Stepper Driver Jumper Configurations for TMC2130 without Sensor-less Homing........629
APPENDIX E......................................................................................................630
  Location Of “firmware.bin” File from the Marlin Compilation for SKR PRO V1.2 Board............................630
APPENDIX F......................................................................................................633
  Links to Reference Material...................................................................................633
    ...
    Facebook Groups.............................................................................................662
APPENDIX G......................................................................................................663
  BIGTREETECH Reference Material for SKR PRO V1.2 Board.........................................................663
    SKR PRO V1.2 Original PIN Diagram...........................................................................663
    SKR PRO V1.2 Original Wiring Diagram 1......................................................................664
    SKR PRO V1.2 Original Wiring Diagram 2......................................................................665
    SKR PRO V1.2 Original PIN 1 Diagram.........................................................................666
    SKR PRO V1.2 Original Schematic Diagram.....................................................................667
APPENDIX H......................................................................................................668
  BIGTREETECH’s Smart Filament Sensor (SFS) Guide for SKR PRO V1.2 Board........................................668
...
APPENDIX I......................................................................................................681
  “Connecting up Raspberry Pi via TFT Connector” Guide for SKR PRO V1.2 Board...................................681
  Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable Via TFT Connector..............................682
    TFT Connector Wiring Diagram for Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable.............685
  Marlin 2.0.x Setup for Connecting up Raspberry Pi.............................................................688
APPENDIX J......................................................................................................691
  “Connecting up Raspberry Pi via UART3 Header” Guide for SKR PRO V1.2 Board....................................691
  Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable Via UART3 Header...............................692
    UART3 Header Wiring Diagram for Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable..............695
  Marlin 2.0.x Setup for Connecting up Raspberry Pi.............................................................698
APPENDIX K......................................................................................................701
  “Connecting up Raspberry Pi via WIFI Header” Guide for SKR PRO V1.2 Board.....................................701
  Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable Via WIFI Header................................702
    WIFI Header Wiring Diagram for Connecting SKR PRO V1.2 to Raspberry Pi to Eliminate USB Cable...............705
  Marlin 2.0.x Setup for Connecting up Raspberry Pi.............................................................708
APPENDIX L......................................................................................................711
  BLTouch Guide for SKR PRO V1.2 Board..........................................................................711
  Connecting SKR PRO V1.2 with BLTouch..........................................................................712
    Wiring Diagram for Connecting SKR PRO V1.2 with BLTouch.....................................................715
  Marlin 2.0.x Firmware Setup for Connecting a BLTouch to SKR PRO V1.2 Board....................................716
...
APPENDIX M......................................................................................................740
  PT100 Sensor Connection Guide to the SKR PRO V1.2 Board via Analog ADC I/O Input..............................740
  Hyperlink Map for this PT100 Sensor Connection Guide via Analog ADC I/O Input.................................741
  Connecting  SKR PRO V1.2 with  PT100 Sensor...................................................................742
  ...
  Analog Procedure..............................................................................................746
    Connecting SKR PRO V1.2 Board with PT100 Amplifier Board and PT100 Sensor...................................746
      Locations of 3.3VDC Referenced to Analog Ground for the SKR PRO V1.2 Board’s Thermistor Ports.............757
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T1 (E0) Thermistor Port...........................759
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T2 (E1) Thermistor Port...........................761
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T3 (E2) Thermistor Port...........................763
    ...
    Marlin 2.0.x Firmware Setup for Connecting a PT100 Sensor to the SKR PRO V1.2 Board.........................786
...
APPENDIX N......................................................................................................869
  PT100 Sensor Connection Guide to the SKR PRO V1.2 Board via Software SPI Protocol.............................869
  Hyperlink Map for this PT100 Sensor Connection Guide via Software SPI Protocol................................870
  Digital Procedure.............................................................................................871
    Connecting  SKR PRO V1.2 with Adafruit MAX31865 Board and PT100 Sensor......................................871
    ...
    Connecting SKR PRO V1.2 with MAX31865 Board via Software SPI................................................875
...
APPENDIX O......................................................................................................943
  PT100 Sensor Connection Guide to the SKR PRO V1.2 Board via Hardware SPI Protocol.............................943
  Hyperlink Map for this PT100 Sensor Connection Guide via Hardware SPI Protocol................................944
  Digital Procedure.............................................................................................945
    Connecting  SKR PRO V1.2 with Adafruit MAX31865 Board and PT100 Sensor......................................945
    ...
    Connecting  SKR PRO V1.2 with MAX31865 Board via Hardware SPI...............................................949
...
APPENDIX P.....................................................................................................1018
  K-Type Thermocouple Sensor Connection Guide to the SKR PRO V1.2 Board via Analog ADC I/O Input...............1018
  Hyperlink Map for this K-Type Thermocouple Sensor Connection Guide via Analog ADC I/O Input..................1019
  Connecting  SKR PRO V1.2 with K-Type Thermocouple Sensor.....................................................1020
  ...
  Analog Procedure.............................................................................................1026
    Connecting SKR PRO V1.2 with K-Type Thermocouple Sensor and Adafruit’s AD8495 Amplifier Board..............1026
      Locations of 3.3VDC Referenced to Analog Ground for the SKR PRO V1.2 Board’s Thermistor Ports............1037
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T1 (E0) Thermistor Port..........................1039
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T2 (E1) Thermistor Port..........................1041
      Hardware Hack Instructions for the SKR PRO V1.2 Board’s T3 (E2) Thermistor Port..........................1043
    Instructions for Supplying Power to the AD8495 Amplifier Board.............................................1046
      ...
      Marlin 2.0.x Firmware Setup for Connecting a K-Type Thermocouple Sensor to the SKR PRO V1.2 Board........1066
...
APPENDIX Q.....................................................................................................1162
  K-Type Thermocouple Sensor Connection Guide to the SKR PRO V1.2 Board via Software SPI Protocol..............1162
  Hyperlink Map for this K-Type Thermocouple Sensor Connection Guide via Software SPI Protocol.................1163
  Digital Procedure............................................................................................1164
    Connecting SKR PRO V1.2 with MAX31855 Amplifier Board and K-Type Thermocouple Sensor.......................1164
    ...
    Connecting SKR PRO V1.2 with MAX31855 Amplifier Board via Software SPI.....................................1170
...
APPENDIX R.....................................................................................................1228
  K-Type Thermocouple Sensor Connection Guide to the SKR PRO V1.2 Board via Hardware SPI Protocol..............1228
  Hyperlink Map for this K-Type Thermocouple Sensor Connection Guide via Hardware SPI Protocol.................1229
  Digital Procedure............................................................................................1230
    Connecting SKR PRO V1.2 with MAX31855 Amplifier Board and K-Type Thermocouple Sensor.......................1230
    ...
    Connecting SKR PRO V1.2 with MAX31855 Amplifier Board via Hardware SPI.....................................1236
      Method #1 (5 VDC Digital PWR) for Powering the MAX31855 Amplifier Board 
...
APPENDIX S.....................................................................................................1295
  EEPROM Guide for SKR PRO V1.2 Board..........................................................................1295
